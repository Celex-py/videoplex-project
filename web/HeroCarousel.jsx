...
const SLIDES = [
  {
    ...
    kicker: "TRENDING NOW",
    meta: "Global movies · Series · Live",
  },
  {
    id: "news",
    category: "LIVE NEWS",
    ...
    kicker: "BREAKING",
    meta: "Live newsroom · Real-time updates",
    ticker: "BREAKING  •  GLOBAL MARKETS UPDATE  •  WEATHER ALERTS  •  WORLD NEWS LIVE",
  },
  {
    id: "football",
    ...
    kicker: "LIVE MATCH",
    meta: "Scores · Fixtures · Highlights",
    score: "ARS 2  —  1 CHE",
    fixture: "Next fixture · 20:00 · Champions Night",
  },
  {
    id: "music",
    category: "MUSIC",
    ...
    kicker: "NOW PLAYING",
    meta: "New releases · Artist spotlight",
    artist: "AYRA STARR",
    track: "Rhythm After Dark",
  },
  {
    id: "movies",
...
export default function HeroCarousel() {
  ...
  return (
    <section
      ...
      aria-label="Videoplex featured categories"
    ...
    >
      ...
      <div className="hero-carousel-content">
        <div className="hero-carousel-copy">
          ...
          {slide.id === "football" && (
            <div className="hero-football-meta">
              <div className="hero-score">{slide.score}</div>
              <div className="hero-fixture">{slide.fixture}</div>
            </div>
          )}
          {slide.id === "music" && (
            <div className="hero-music-meta">
              <div className="hero-album-art">♪</div>
              <div><strong>{slide.artist}</strong><span>{slide.track}</span></div>
            </div>
          )}
          {slide.id === "movies" && (
            <div className="hero-family-posters" aria-hidden="true">
              <span className="hero-poster movie-poster">BLOCKBUSTER</span>
              <span className="hero-poster cartoon-poster">TOON<br />WORLD</span>
            </div>
          )}
      ...
      <div className="hero-carousel-controls">
        <button type="button" className="hero-arrow" onClick={previous} aria-label="Previous slide">‹</button>
        <div className="hero-progress" role="tablist" aria-label="Hero slides">
          {SLIDES.map((item, index) => (
            <button
              ...
              className={`hero-progress-item${index === active ? " is-active" : ""}`}
        ...
        <button type="button" className="hero-arrow" onClick={next} aria-label="Next slide">›</button>
      </div>
